"""NCAAW (Women's Basketball) team names and abbreviations."""
...
NCAAW_ABBREVIATIONS = {
    ...
    "lib": "Liberty Lady Flames",
    "latech": "Louisiana Tech Lady Techsters",
    ...
    "scsu": "South Carolina State Lady Bulldogs",
    "umd": "UMES Hawks",
    ...
    "aamu": "Alabama A&M Lady Bulldogs",
    "alst": "Alabama State Lady Hornets",
    "alc": "Alcorn State Lady Braves",
    "uapb": "Arkansas-Pine Bluff Golden Lions",
    "bcu": "Bethune-Cookman Wildcats",
    "fam": "Florida A&M Rattlers",
    "gram": "Grambling State Lady Tigers",
    "jst": "Jackson State Lady Tigers",
    "mvsu": "Mississippi Valley State Devilettes",
    "pvam": "Prairie View A&M Lady Panthers",
    "sou": "Southern Lady Jaguars",
    "txso": "Texas Southern Lady Tigers",
    ...
    "odu": "Old Dominion Lady Monarchs",
    "sal": "South Alabama Jaguars",
    "usm": "Southern Miss Lady Eagles",
    ...
    "eatm": "East Texas A&M Lady Lions",  # Transitioning from D2
...
TEAM_FULL_NAMES = {
    ...
    "volunteers": "Tennessee Lady Vols",
