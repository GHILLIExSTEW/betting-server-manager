"""NCAAW (Women's Volleyball) team names and abbreviations."""
...
NCAAW_ABBREVIATIONS = {
    ...
    # American Athletic Conference (AAC) (12 teams, no Tulsa)
    ...
    # Atlantic 10 Conference (A-10) (12 teams, no St. Bonaventure, La Salle, Saint Louis)
    ...
    # Big South Conference (8 teams, no Presbyterian)
    ...
    # Metro Atlantic Athletic Conference (MAAC) (11 teams, no Mercyhurst, St. Francis Brooklyn)
    ...
    # Mid-Eastern Athletic Conference (MEAC) (6 teams, no Coppin State, UMES)
    ...
    # Northeast Conference (NEC) (9 teams, no St. Francis Brooklyn)
    ...
    "soind": "Southern Indiana Screaming Eagles",
    ...
    # Patriot League (8 teams, no Army, Navy)
    ...
    # Southern Conference (SoCon) (8 teams, no Citadel, VMI)
    ...
    # Southwestern Athletic Conference (SWAC) (6 teams, no Alabama A&M, Alcorn State, Ark-Pine Bluff, Bethune-Cookman, Florida A&M, Prairie View A&M)
    ...
    "eatm": "East Texas A&M Lady Lions",
